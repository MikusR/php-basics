...
$arrayOfTenIntegers = [];
for ($i = 0; $i < 10; $i++) {
    $arrayOfTenIntegers[] = mt_rand(1, 100);
}
$copyOfArrayOfTenIntegers = $arrayOfTenIntegers;
$arrayOfTenIntegers[count($arrayOfTenIntegers) - 1] = -7;
echo 'Array 1: ' . implode(' ', $arrayOfTenIntegers) . "\n";
echo 'Array 2: ' . implode(' ', $copyOfArrayOfTenIntegers) . "\n";
